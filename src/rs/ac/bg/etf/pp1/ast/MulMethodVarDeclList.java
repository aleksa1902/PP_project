...
public class MulMethodVarDeclList extends MethodVarDeclList {

    private MethodVarDeclList MethodVarDeclList;
    private VarDecl VarDecl;

    public MulMethodVarDeclList (MethodVarDeclList MethodVarDeclList, VarDecl VarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MulMethodVarDeclList(\n");
